                        ...
                        <table className="w-full text-right border-collapse">
                            <thead>
                                <tr className="bg-slate-50/50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800">
                                    <th className="px-6 py-3 text-xs font-black text-slate-500 uppercase tracking-wider">שם מלא</th>
                                    <th className="px-6 py-3 text-xs font-black text-slate-500 uppercase tracking-wider">מ.א</th>
                                    <th className="px-6 py-3 text-xs font-black text-slate-500 uppercase tracking-wider">מחלקה</th>
                                    <th className="px-6 py-3 text-xs font-black text-slate-500 uppercase tracking-wider">מדור / חולייה</th>
                                    <th className="px-6 py-3 text-xs font-black text-slate-500 uppercase tracking-wider">טלפון</th>
                                </tr>
                            </thead>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-[10px] text-slate-400 font-medium">
                                                    {emp.team_name && emp.team_name !== 'מטה' ? emp.team_name : ''}
                                                </span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
