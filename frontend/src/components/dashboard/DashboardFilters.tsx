      ...
      <div className="p-4 flex flex-col gap-4 flex-1">
        ...
        <div className="space-y-4 flex-1">
          ...
          <div className="space-y-1.5">
            ...
            >
              <SelectTrigger
                className="h-10 text-right font-bold text-xs bg-muted/30 border-input w-full"
                dir="rtl"
              >
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              >
                <SelectValue
                  placeholder={
                    !selectedDeptId ? "בחר מחלקה תחילה..." : "כל המדורים"
                  }
                />
              </SelectTrigger>
              <SelectContent dir="rtl">
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              >
                <SelectValue
                  placeholder={
                    !selectedSectionId ? "בחר מדור תחילה..." : "כל החוליות"
                  }
                />
              </SelectTrigger>
              <SelectContent dir="rtl">
        ...
        <div className="space-y-1.5">
          ...
          >
            <SelectTrigger
              className="h-10 text-right bg-primary/5 border-primary/20 font-bold text-xs text-primary w-full"
              dir="rtl"
            >
