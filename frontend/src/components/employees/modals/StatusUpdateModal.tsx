                      ...
                      {visibleParents.map((type: any) => {
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              "flex flex-col items-center justify-center gap-2.5 p-3 rounded-3xl border transition-all text-center h-full min-h-[105px] group relative overflow-visible shadow-[0_2px_8px_rgba(0,0,0,0.02)]",
                              sel
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        className="h-11 bg-muted/20 border border-border/40 rounded-xl text-right pr-10 pl-3 text-sm font-bold text-foreground focus:bg-background focus:ring-4 focus:ring-primary/5 focus:border-primary/45 outline-none transition-all w-full dark:bg-white/5 dark:border-white/10 dark:text-white"
                      />
                    </div>
                  </div>
                  <div className="space-y-1.5">
