          ...
          <div className="bg-amber-500/10 border-r-4 border-amber-500 p-4 mb-6 flex items-start gap-3">
            ...
            <div className="text-sm leading-relaxed">
              ...
              <p className="text-amber-600 font-medium">
                זוהי התחברות ראשונית למערכת השוטר. למען אבטחת המידע, עליך לבחור
                סיסמה אישית חדשה שתשמש אותך בכניסות הבאות.
              </p>
            </div>
          </div>
            ...
            <div className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-muted rounded-lg p-3 text-[11px] text-muted-foreground space-y-1">
                  <p className="font-bold text-muted-foreground/70 uppercase tracking-tighter mb-1">
                    המלצות לסיסמה חזקה:
                  </p>
