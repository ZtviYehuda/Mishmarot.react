...
export default function EmployeeViewPage() {
  ...
  return (
    <div
      className="min-h-screen bg-slate-50/50 dark:bg-slate-950 pb-20 animate-in fade-in duration-300"
      dir="rtl"
    >
      {/* Inactive Banner */}
      {!employee.is_active && (
        ...
        <div className="max-w-7xl mx-auto">
          <PageHeader
            ...
            iconClassName={cn(
              ...
              !employee.is_active && "from-red-50 to-red-100 border-red-200",
            )}
            badge={
              <div className="flex gap-3">
                <Button
                  onClick={() => navigate(`/employees/edit/${employee.id}`)}
                  className="bg-primary hover:opacity-90 text-white shadow-lg shadow-primary/20 rounded-xl px-6 h-11 font-black transition-all"
                >
